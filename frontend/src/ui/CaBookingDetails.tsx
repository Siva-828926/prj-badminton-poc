...
const CaBookingDetails: React.FC<CaBookingDetailsProps> = ({
  ...
  return (
    <div className="border border-gray-200 rounded-lg shadow-lg p-4 flex flex-col justify-between bg-gradient-to-r from-white to-gray-200 w-full">
      <div className="flex flex-col gap-1 mb-2">
        ...
        <div className="flex justify-between items-center mb-1">
          ...
          <div className="flex items-center gap-2">
            <FaFutbol className="text-gray-700" />
